...
export function Tabela() {
  const [modoVisualizacao, setModoVisualizacao] = useState<'pontos_corridos' | 'mata_mata'>('pontos_corridos');
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-800">
              ...
              {modoVisualizacao === 'mata_mata' && (
                <>
                  <th className="text-center py-4 px-3 text-sm font-medium text-gray-400">Fase</th>
                  <th className="text-center py-4 px-3 text-sm font-medium text-gray-400">Status</th>
                </>
              )}
            </tr>
          </thead>
                  ...
                  <>
                    <td className="text-center py-4 px-3">
                      <span className="text-sm text-gray-300">
                        {index + 1 <= 7 ? 'Oitavas' : 'Eliminado'}
                      </span>
                    </td>
                    <td className="text-center py-4 px-3">
                      <span className={`text-xs px-2 py-1 rounded-full ${
                        index + 1 <= 7 ? 'bg-green-500/20 text-green-500' : 'bg-red-500/20 text-red-500'
                      }`}>
            ...
            {modoVisualizacao === 'mata_mata' && (
              <div className="text-center">
                <span className={`text-xs px-2 py-1 rounded-full ${
                  ...
                  {index + 1 <= 7 ? 'Classificado - Oitavas' : 'Eliminado'}
                </span>
              </div>
            )}
          </div>
